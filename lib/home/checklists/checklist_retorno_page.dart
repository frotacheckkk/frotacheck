...
class _ChecklistRetornoPageState extends State<ChecklistRetornoPage> {
  ...
  Future<void> _salvarChecklist() async {
    ...
    try {
      ...
      final checklistData = {
        ...
        'km_final': int.tryParse(kmFinalController.text) ?? 0,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Checklist de retorno registrado com sucesso!'),
        ),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Checklist de Retorno - ${widget.veiculoPlaca}'),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Descreva qualquer anomalia encontrada...',
                ),
              ),
            ),
            const SizedBox(height: 24),
